namespace PuntodeVentaTintoreria.ClaseAux
{
    ...
    public class Impresor : IDisposable
    {
        ...
        private void Export(LocalReport report)
        {
            ...
            //report.PrinterSettings.DefaultPageSettings.PaperSize = new PaperSize("Custom", 650, 325);
        ...
        private void PrintPage(object sender, PrintPageEventArgs ev)
        {
            ...
            Rectangle adjustedRect = new Rectangle(0, 0, 300, 800);
        ...
        private void Print()
        {
            ...
            String printerName = Comun.namePrinter;
