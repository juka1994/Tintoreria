...
{
    public partial class frm_PedirKilogramos : Form
    {
        public frm_PedirKilogramos()
        {
            try
            {
                InitializeComponent();
        ...
        private void frm_PedirCadenaTexto_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.txtPrecio.Text = _precio.ToString();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                if ((string.IsNullOrEmpty(this.txtPrecio.Text) || string.IsNullOrWhiteSpace(this.txtPrecio.Text)))
                {
