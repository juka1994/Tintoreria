namespace PuntodeVentaTintoreria
{
    ...
    public partial class frmStockAgregar : Form
    {
        ...
        public frmStockAgregar(Almacen almacen)
        {
            InitializeComponent();
        ...
        private void frmStockAgregar_Load(object sender, EventArgs e)
        {
            try
            {
                using (new Recursos.CursorWait())
        ...
        private void TxtCantidadIngresar_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                MessageBox.Show(this, ex.Message.ToString(), Comun.NOMBRE_SISTEMA, MessageBoxButtons.OK, MessageBoxIcon.Error);
                LogError.AddExcFileTxt(ex, "frmStockAgregar ~ TxtCantidadIngresar_KeyPress");
            }
        }
